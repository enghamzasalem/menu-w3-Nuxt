  ...
  <div class="w3-container w3-black w3-padding-64 w3-xxlarge" id="menu">
    <div class="w3-content">
      ...
      <div id="Pizza" v-bind:style="{display:v1}" class="w3-container w3-padding-32 w3-white">
        ...
        <p
          class="w3-text-grey"
        >Fresh tomatoes, mozzarella, hot pepporoni, hot sausage, beef, chicken</p>
        <hr />
      ...
      <div id="Pasta" v-bind:style="{display:v2}" class="w3-container w3-padding-32 w3-white">
        <h1>
          <b>Lasagna</b>
      ...
      <div id="Starter" v-bind:style="{display:v3}" class="w3-container w3-padding-32 w3-white">
        <h1>
          <b>Today's Soup</b>
